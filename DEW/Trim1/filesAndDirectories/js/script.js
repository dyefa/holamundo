        ...
        items[i].addEventListener('click', function(e) {
            ...
            btn.addEventListener('click', function(e) {
                ...
                if (val == 404) {
                    ...
                    template.innerHTML = '<label class="custom-checkbox"><input type="checkbox" checked/><i class="fas fa-folder unchecked"></i><i class="fas fa-folder-open checked"></i><span class="text">';
                    template.innerHTML += e.target.previousSibling.value + '</span></label>';
